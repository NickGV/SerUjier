...
export function BottomNavigation({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg backdrop-blur-sm bg-white/95 z-50 pb-safe">
      {/* User Info */}
      <div className="px-3 py-2.5 border-b border-gray-100 bg-gray-50/90">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="ml-1.5 text-xs hidden sm:inline">Salir</span>
          </Button>
        </div>
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Button
              key={item.id}
              variant="ghost"
              className={`flex-1 flex flex-col items-center gap-1.5 h-14 sm:h-16  rounded-none border-r border-gray-100 last:border-r-0 p-2 ${
                isActive
